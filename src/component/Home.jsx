...
export default function Home() {
  return (
    ...
    <div className="logo">
    <div id="context">
    <div id="logoText"><h4>CRYPTO<p>GRAM</p></h4>
    </div> 
    </div>
     </div>
       ...
       <div className="poster">
        ...
        <div className="post img3"><img src={post3} alt="hero3" /> <h5>A community where each other helps to make money, and teh distribution of capital is clear and fair</h5></div>
       </div>
</section>
  )
}
