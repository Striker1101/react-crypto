    ...
    <div id="container">
     <header id="header">
        <div className="headerContainer">
         <Link to={'/'}><img className="home" src={logo} alt="logo" /></Link>
        <div className="reg"><h1>REGISTER WITH US </h1></div>
        </div>
     </header>
     <main id="mainContent">
        ...
        <div className="mainContainer">
            ...
            <form id="Form" >
                <label htmlFor="motivation" id="motivation">Let's do this!</label>
                ...
                <input type="text" id="username" name="username" required placeholder="johnSmith"
                ...
                <input type="submit" className="submit" value="submit" title="click to submit your details" />
